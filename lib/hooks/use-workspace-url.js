...
export function useWorkspaceUrl() {
  ...
  const buildUrl = useCallback(
    ...
    [projectId, tab, eventId, section, workflowId, venueId, conversationId, viewId, pathname],
  );
  ...
  // Switching workspace tabs exits any open event/section/workflow/venue and
  // any open conversation/view.
